...
<head>
    ...
    <link rel="stylesheet" href="./css/student/leaderboard.css">
    <link rel="stylesheet" href="./css/student/overlay.css">
...
<body>
    ...
    <div class="slider">
        <div class="top">
            ...
            <ul class="links">
                ...
                <li class="active"><a href="./leaderboard.php">
    ...
    <script src="./js/student/leaderboard.js?=2"></script>
</body>
</html>